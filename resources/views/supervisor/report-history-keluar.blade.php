                                ...
                                <tbody>
                                    @foreach ($reports as $report)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('supervisor.add.product.surat.jalan', $report->kode) }}" class="btn btn-primary">Detail</a>
                                                <a href="{{ route('supervisor.cetak.surat.jalan.excel', $report->kode) }}" class="btn btn-success">Cetak Excel</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
