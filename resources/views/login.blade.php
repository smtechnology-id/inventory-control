...
<head>
    ...
    <!-- Title -->
    <title>Login || Sistem Informasi Inventory Control</title>
...
<body>
    <div class="app app-auth-sign-in align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            <div class="logo">
                <a href="{{ route('login') }}">Sistem Informasi Inventory Control</a>
            </div>
            @if (session('success'))
            ...
            @endif
            <p class="auth-description">Silahkan Login untuk melanjutkan ke dashboard.</p>
